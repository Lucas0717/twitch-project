...
public class RecommendationService {
    ...
    public Map<String, List<Item>> recommendationByDefault() throws RecommendationException {
    ...
    public  Map<String, List<Item>> recommendItemsByUser(String userId) throws RecommendationException {
        ...
        for (Map.Entry<String, List<String>> entry: favoriteGameIds.entrySet()) {
            if (entry.getValue().size() == 0) {
                ...
                recommendItemMap.put(entry.getKey(), recommendFavoriteHistory(favoriteItemIds, entry.getValue(), ItemType.valueOf(entry.getKey())));            }
        }
        return recommendItemMap;
    }
    public List<Item> recommendFavoriteHistory(Set<String> favoriteItemIds, List<String> favoriteGameIds, ItemType type) {
        ...
        // Search Twitch based on the favorite game IDs return in the last step.
